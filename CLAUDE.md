...
| `inventory-requisitions` | inventory          | Phiếu lãnh vật tư — đường **duy nhất** đưa RM ra khỏi kho cho SX; 6 trạng thái riêng; `approve` tự sinh 1 `inventory_issues DRAFT`, kho `post` bên `inventory-issues` mới trừ tồn |
