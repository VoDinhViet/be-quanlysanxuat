 ...
 * they are protected. To turn enforcement on, see the "Đường nâng cấp" section of
 * `docs/features/files.md` — add the field, add a guard reading `?type=`, and use OR semantics.
 */
