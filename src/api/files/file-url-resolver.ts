 ...
 * expiring download link. The default throws rather than falling back to a plain path: a silent
 * fallback would emit URLs that 401 at download time, invisibly. Failing loudly at the first
 * mapping is the cheaper failure.
 */
