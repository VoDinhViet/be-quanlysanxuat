...
export class CreateClientReqDto {
  ...
  @StringFieldOptional({ description: 'Client code; auto-generated if omitted', maxLength: 50 })
  code?: string;

  @StringFieldOptional({ description: 'Tax code (Mã số thuế)', nullable: true, maxLength: 50 })
  taxCode?: string | null;
  ...
  @StringFieldOptional({ description: 'Address', nullable: true, maxLength: 500 })
  address?: string | null;
