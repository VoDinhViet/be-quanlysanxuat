...
export class IqcController {
  ...
  @ApiAuth({
    summary:
      'Xuất Excel danh sách IQC — cùng bộ lọc GET /iqc, không phân trang',
    fileType: XLSX_MIME,
  })
  exportIqc(@Query() reqDto: ExportIqcReqDto): Promise<StreamableFile> {
    return this.iqcService.exportIqc(reqDto);
  }
