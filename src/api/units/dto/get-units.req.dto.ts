 ...
 * a dropdown — see `docs/features/units.md`.
 */
export class GetUnitsReqDto {
  @StringFieldOptional({ description: 'Search on code or name (accent-insensitive)' })
  readonly q?: string;

  @EnumFieldOptional(() => UnitScope, {
    description: 'Only return units assignable to this kind of entity. Omit for all units.',
  })
