...
export const rbacPermissionsSeed: PermissionSeed[] = [
  ...
  { group: 'products', code: 'products:read', name: 'Xem sản phẩm' },
  { group: 'products', code: 'products:create', name: 'Tạo sản phẩm' },
  { group: 'products', code: 'products:update', name: 'Sửa sản phẩm' },
  { group: 'products', code: 'products:delete', name: 'Xóa sản phẩm' },
  { group: 'products', code: 'products:lock', name: 'Khóa sản phẩm' },
  { group: 'products', code: 'products:copy', name: 'Sao chép sản phẩm' },
  { group: 'products', code: 'products:bom-manage', name: 'Quản lý BOM sản phẩm' },
  { group: 'products', code: 'products:routing-manage', name: 'Quản lý routing sản phẩm' },
...
export const rbacRolePermissionCodesSeed: Record<Role, string[]> = {
  ...
  [Role.QC]: ['qc-stock-in-quality:approve'],
  [Role.BUSINESS]: [
    'orders:create',
    'orders:read',
    'orders:update',
