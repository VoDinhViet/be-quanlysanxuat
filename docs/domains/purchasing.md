...
PO:   (lập tay: E249 trùng dòng ĐXMH, E125 dòng không APPROVED/đã huỷ, E019 NCC)
      ...
      DRAFT ──confirm (đủ ngày giao+kho nhận+paymentTerm+mọi dòng có giá, E134/E155/E156/E135)──> ORDERED
...
- `confirm` PO chặn thiếu `expectedDate`/`receiptWarehouseId`/`paymentTerm`/giá dòng
  (`E134`/`E155`/`E156`/`E135`).
...
- **→ Warehouses**: `purchase_orders.receiptWarehouseId` — id gửi thẳng từ picker, không
  resolve/validate lại, bắt buộc trước `confirm`.
